...
#define USB_GS_CAN_INTERFACE_INDEX       (0U)
#define USB_GS_CAN_ENDPOINT_COUNT        (2U)
#define USB_GS_CAN_BULK_IN_ENDPOINT      (1U)
#define USB_GS_CAN_BULK_OUT_ENDPOINT     (2U)
#define HS_GS_CAN_BULK_IN_PACKET_SIZE    (512U)
#define FS_GS_CAN_BULK_IN_PACKET_SIZE    (64U)
#define HS_GS_CAN_BULK_OUT_PACKET_SIZE   (512U)
#define FS_GS_CAN_BULK_OUT_PACKET_SIZE   (64U)

#define USB_MSC_DISK_INTERFACE_INDEX     (3U)
#define USB_MSC_DISK_ENDPOINT_COUNT      (2U)
#define USB_MSC_DISK_BULK_IN_ENDPOINT    (5U)
#define USB_MSC_DISK_BULK_OUT_ENDPOINT   (6U)
#define HS_MSC_DISK_BULK_IN_PACKET_SIZE  (512U)
#define FS_MSC_DISK_BULK_IN_PACKET_SIZE  (64U)
#define HS_MSC_DISK_BULK_OUT_PACKET_SIZE (512U)
#define FS_MSC_DISK_BULK_OUT_PACKET_SIZE (64U)

#define USB_MSC_DISK_INTERFACE_COUNT                (1U)
#define USB_MSC_DISK_INTERFACE_ALTERNATE_COUNT      (1U)
#define USB_MSC_DISK_INTERFACE_ALTERNATE_0          (0U)
#define USB_MSC_DISK_CLASS                          (0x08U)
#define USB_MSC_DISK_SUBCLASS                       (0x06U)
#define USB_MSC_DISK_PROTOCOL                       (0x50U)
...
#define USB_CDC_VCOM_INTERRUPT_IN_ENDPOINT          (2U)
#define USB_CDC_VCOM_BULK_IN_ENDPOINT               (3U)
#define USB_CDC_VCOM_BULK_OUT_ENDPOINT              (4U)
#define USB_CDC_VCOM_INTERFACE_COUNT                (2U)
#define USB_CDC_VCOM_COMM_INTERFACE_INDEX           (1U)
#define USB_CDC_VCOM_DATA_INTERFACE_INDEX           (2U)
...
#define USB_DEVICE_INTERFACE_COUNT (4U)
